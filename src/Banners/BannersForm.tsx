      ...
      <Form>
        <Grid>
          ...
          <Grid.Row>
            ...
            <Grid.Column width={3}>
              <BannersDatePicker
                selectedDate={banner.startDate}
                onChange={e =>
                  onFormValueChange(e, { name: 'startDate', value: e })
                }
              />
            </Grid.Column>
          </Grid.Row>
          <Grid.Row>
            ...
            <Grid.Column width={3}>
              <BannersDatePicker
                selectedDate={banner.endDate}
                onChange={e =>
                  onFormValueChange(e, { name: 'endDate', value: e })
                }
              />
            </Grid.Column>
          </Grid.Row>
